...
module.exports = Thakku = async (Thakku, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            Thakku.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` ᴛʜᴀᴋᴋᴜ-ᴍᴅ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/thakku.jpg`),"sourceUrl": "https://raw.githubusercontent.com/TOXIC-KICHU/THAKKU-MD/master/media/thakku.jpg"}}}, { quoted: m})
        }
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await Thakku.setStatus(`${Thakku.user.name} | Rᴜɴᴛɪᴍᴇ : ${runtime(uptime)}`)
	  ...
	  //antilink\\
        ...
        if (!isBotAdmins) return reply(`I Aᴍ Nᴏᴛ Aɴ Aᴅᴍɪɴ, Hᴏᴡ Cᴏᴜʟᴅ I Kɪᴄᴋ Sᴏᴍᴇʙᴏᴅʏ Wʜᴏ Sᴇɴᴅ Lɪɴᴋ😒`)
        let gclink = (`https://chat.whatsapp.com/`+await Thakku.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return reply(`Gʀᴏᴜᴘ Is Iɴsᴛᴀʟʟᴇᴅ Wɪᴛʜ Aɴᴛɪ-Lɪɴᴋ Bᴜᴛ I Wᴏɴ'ᴛ Kɪᴄᴋ Yᴏᴜ 😉, Bᴇᴄᴀᴜsᴇ Yᴏᴜ Sᴇɴᴛ Lɪɴᴋ Oғ Tʜɪs Gʀᴏᴜᴘ❤️`)
        if (isAdmins) return reply(`Gʀᴏᴜᴘ Is Iɴsᴛᴀʟʟᴇᴅ Wɪᴛʜ Aɴᴛɪ-Lɪɴᴋ Bᴜᴛ I Wᴏɴ'ᴛ Kɪᴄᴋ Yᴏᴜ 😉, Bᴇᴄᴀᴜsᴇ Yᴏᴜ Aʀᴇ Tʜᴇ Aᴅᴍɪɴ Oғ Tʜɪs Gʀᴏᴜᴘ❤️`)
        if (isCreator) return reply(`Gʀᴏᴜᴘ Is Iɴsᴛᴀʟʟᴇᴅ Wɪᴛʜ Aɴᴛɪ-Lɪɴᴋ Bᴜᴛ I Wᴏɴ'ᴛ Kɪᴄᴋ Yᴏᴜ 😉, Bᴇᴄᴀᴜsᴇ Yᴏᴜ Aʀᴇ Mʏ Oᴡɴᴇʀ Hᴀʜᴀʜᴀʜ🤣😘, Yᴏᴜ Tʜɪɴᴋ I ᴡɪʟ Bᴇᴛʀᴀʏ Yᴏᴜ Hᴜʜ🐦`)
        ...
        for (let anji of setik){
				if (budy === anji){
					...
					Thakku.sendMessage(m.chat, { sticker: result }, { quoted: m })
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					Thakku.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					Thakku.sendMessage(m.chat, { image: result }, { quoted: m })
					}
			}
					for (let anjh of videox){
				if (budy === anjh){
					result = fs.readFileSync(`./media/vid/${anjh}.mp4`)
					Thakku.sendMessage(m.chat, { video: result }, { quoted: m })
					}
				  }
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Thakku.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `🎮 Guess The Music 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Thakku.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Thakku.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Thakku.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Thakku.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Thakku.user.name, m)
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     var Thakku = await getBuffer(picak+`User's Inventory`)
     ...
     await Thakku.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, Thakku, [{"urlButton": {"displayText": "Iɴsᴛᴀ","url": `https://instagram.com/kichu_nrd?igshid=YmMyMTA2M2Y=`}}])
  }
  break
        case 'userlimit': 
{      
   let txt = `「 *Aʟʟ Lɪᴍɪᴛ Usᴇʀ* 」\n\n`
     for (let i of _limit){
     txt += `➸ *Iᴅ :* @${i.id.split("@")[0]}\n➸ *Lɪᴍɪᴛ* : ${i.limit}\n`
     }
    reply(txt)       
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  let buttons = [
    ...
    let buttonMessage = {
     ...
     Thakku.sendMessage(from, buttonMessage, { quoted: m })
...
if (q.includes('--help')) return reply(examkosong) 
 ...
 if (isMonay < noh) return reply('Yᴏᴜʀ Rᴇᴍᴀɪɴɪɴɢ Mᴏɴᴇʏ Is Nᴏᴛ Sᴜғғɪᴄᴇɴᴛ Fᴏʀ Tʜɪs Pᴜʀᴄʜᴀsᴇ')
...
Type *surrender* to surrender and admit defeat`
            ...
            reply('Wᴀɪᴛɪɴɢ Fᴏʀ Pᴀʀᴛɴᴇʀ' + (text ? ` Type The Command Below ${prefix}${command} ${text}` : ''))
            ...
            if (this.game) {
            delete this.game
            Thakku.sendText(m.chat, `Successfully Deleted The TicTacToe Session`, m)
            } else if (!this.game) {
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) Thakku.sendText(m.chat, `_Suit Time Out_`, m)
            delete this.suit[id]
            ...
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    Thakku.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    Thakku.chatModify({ mute: null }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    Thakku.chatModify({  archive: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    Thakku.chatModify({ archive: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    Thakku.chatModify({ markRead: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    Thakku.chatModify({ markRead: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    Thakku.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
                if ('family100'+m.chat in _family100) {
                    reply('Tʜᴇʀᴇ Aʀᴇ Sᴛɪʟʟ Uɴғɪɴɪsʜᴇᴅ Sᴇssɪᴏɴs!')
                    reply(false)
                }
            ...
            case 'guess': {
                ...
                if (args[0] === "song") {
                    ...
                    Thakku.sendText(m.chat, `What Is The Name Of This Song?\n\nArtist : ${result.artist}\nTime : 60 seconds`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `Time Has Run Out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant To Play? Press The Button Below`, Thakku.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Thakku.sendImage(m.chat, result.img, `Please Answer The Questions Above\n\nDescription : ${result.deskripsi}\nTime : 60 seconds`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `Time Has Run Out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Thakku.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'word') {
                    ...
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Thakku.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Thakku.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Thakku.sendText(m.chat, `These Are The Lyrics Of Which Song? : *${result.soal}*?\nTime : 60 seconds`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\Want To Play Again? PressThe Button Below`, Thakku.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Thakku.sendText(m.chat, `*Answer The Following Questions :*\n${result.soal}*\nTime : 60 seconds`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Answer: " + result.jawaban)
                    Thakku.sendButtonText(m.chat, [{ buttonId: 'guess blank', buttonText: { displayText: 'Guess The Blank' }, type: 1 }], `Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\Want To Play Again? PressThe Button Below`, Thakku.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
	...
	case 'react': {
            ...
            case 'kuismath': case 'math': {
                ...
                Thakku.sendText(m.chat, `*What Is The Result Of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
...
Thakku.sendMessage(from, { text: `Question : Is ${q}\nAnswer : ${kah}` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `Question : What ${q}\nAnswer : ${kahk}` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `Question : Can ${q}\nAnswer : ${ga}` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `Question : ${q}\nAnswer : How ${ya}` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `Rate : ${q}\nAnswer : *${te}%*` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
...
Thakku.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
					...
					Thakku.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
                    case 'stupid':
      case 'foolish':
      case 'smart':
...
case 'wangy':
             ...
             reply(awikwok)
              break
case 'checkdeath':
             if (!text) return replay(`Use Someone's Name, Example : ${prefix + command} Toxic Kichu`)
...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
            ...
            case 'join': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Eɴᴛᴇʀ Tʜᴇ Gʀᴏᴜᴘ Lɪɴᴋ!`)
                if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) return replay(`Iɴᴠᴀɪʟᴅ Lɪɴᴋ!`)
                reply(mess.wait)
                let result = args[0].split('https://chat.whatsapp.com/')[1]
                await Thakku.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'leave': {
                if (!isCreator) return replay(`${mess.owner}`)
                await Thakku.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'setexif': {
               if (!isCreator) return replay(`${mess.owner}`)
	...
	case 'kick': {
		...
		await Thakku.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'add': {
		if (!m.isGroup) return replay(`${mess.group}`)
		...
		await Thakku.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'promote': {
		if (!m.isGroup) return replay(`${mess.group}`)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Thakku.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'demote': {
		if (!m.isGroup) return replay(`${mess.group}`)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Thakku.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'block': {
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Thakku.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'unblock': {
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Thakku.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	    case 'setname': case 'setgcname': case 'setsubject': {
                ...
                if (!text) replay(`Wʜᴇʀᴇ Is Tʜᴇ Tᴇxᴛ?`)
                await Thakku.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
          case 'setdesc': case 'setdesk': {
                ...
                await Thakku.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
          case 'setbotpp': {
                if (!isCreator) return replay(`${mess.owner}`)
		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
                if (args[0] === 'close'){
                    await Thakku.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Successful Closing The Group`)).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await Thakku.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Successful Opening The Group`)).catch((err) => reply(jsonformat(err)))
                } else {
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await Thakku.sendButtonText(m.chat, buttons, `Group Mode`, Thakku.user.name, m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await Thakku.sendButtonText(m.chat, buttons, `Mode Edit Info`, Thakku.user.name, m)
            ...
            case 'antilink': {
                ...
                reply(`Antilink Inactive !`)
                 ...
                 let buttons = [
                    ...
                    await Thakku.sendButtonText(m.chat, buttons, `Antilink Mode`, Thakku.user.name, m)
                }
             }
             break
             case 'mute': {
                ...
                reply(`${Thakku.user.name} Has Been Muted In This Group !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return reply(`Previously Inactive`)
                db.data.chats[m.chat].mute = false
                reply(`${Thakku.user.name} Has Been Unmuted In This Group!`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'Oɴ' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Oғғ' }, type: 1 }
                    ]
                    await Thakku.sendButtonText(m.chat, buttons, `Mute Bot`, Thakku.user.name, m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                if (args[0] === 'enable') {
                    await Thakku.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'disable') {
                    await Thakku.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Where Is The Text?\n\nExample : ${prefix + command} Toxic Kichu`)
	    ...
	    break
            case 'listpc': case 'pclist': {
             ...
             case 'listonlinexxx': case 'onlinelistxxx': {
                    ...
                    Thakku.sendText(m.chat, 'Online List:\n\n' + online.map(v => '🐦 @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
...
reply(mess.wait)
mee = await Thakku.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`
memek = await Thakku.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            Thakku.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${Thakku.user.name}.mp3`}, { quoted : m })
            }
            break
...
case 'webtonsearch': case 'webtoon':
            ...
            case 'animexxx':{
				...
				await Thakku.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(mess.error)
                })
            ...
            case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                reply(mess.wait)
                Thakku.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'Generated Random ' + command }, { quoted: m })
            }
            break
	    case 'couplepp':  case 'ppcouple': {
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                Thakku.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male🙎🏻‍♂️` }, { quoted: m })
                Thakku.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female🙎🏻‍♀️` }, { quoted: m })
            }
	    break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Name :* ${anu.message.nama}\n🐦 *Meaning :* ${anu.message.arti}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Wedding Date :* ${anu.message.tanggal}\n🐦 *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Born :* ${anu.message.hari_lahir}\n🐦 *Business :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendImage(m.chat, anu.message.image, `🐦 *Born :* ${anu.message.tgl_lahir}\n🐦 *Tarot Symbol :* ${anu.message.simbol_tarot}\n🐦 *Meaning :* ${anu.message.arti}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'haribaik': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Born :* ${anu.message.tgl_lahir}\n🐦 *When Challenged :* ${anu.message.kala_tinantang}\n🐦 *Info :* ${anu.message.info}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Date :* ${anu.message.tgl_memancing}\n🐦 *Results :* ${anu.message.result}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Results :* ${anu.message.result}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return reply(anu.message)
                Thakku.sendText(m.chat, `🐦 *Results :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply('Your Daily Limit Has Expired')
	        ...
	        case 'instagramx': case 'igx': case 'igdlx': {
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    ...
                    for (let media of anu.data) Thakku.sendMedia(m.chat, media, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
                    Thakku.sendMedia(m.chat, anu.media[0].url, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
                ...
                Thakku.sendMessage(m.chat, { video: { url: anu.data[0] } }, { quoted: m })
            }
            break
	        ...
	        case 'fbdlx': case 'fbx': case 'facebookx': {
                ...
                Thakku.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `🐦 Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		...
		Thakku.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
	    ...
	    case 'anonymous': {
            ...
            case 'keluar': case 'leave': {
                ...
                if (!room) {
                    ...
                    await Thakku.sendButtonText(m.chat, buttons, `\`\`\`You Are Not In An Anonymous Session, Press The Button To Find A Partner \`\`\``)
                   reply(false)
                }
                reply('Ok')
                let other = room.other(m.sender)
                if (other) await Thakku.sendText(other, `\`\`\`Partner Has Left Anonymous Session\`\`\``, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await Thakku.sendButtonText(m.chat, buttons, `\`\`\`You Are Still In An Anonymous Session, Press The Button Below To Terminate Your Anonymous Session\`\`\``, Thakku.user.name, m)
                    reply(false)
                }
                ...
                if (room) {
                    ...
                    await Thakku.sendButtonText(room.a, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, Thakku.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await Thakku.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, Thakku.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await Thakku.sendButtonText(m.chat, buttons, `\`\`\`Please Wait, Looking For A Partner\`\`\``, Thakku.user.name, m)
                }
                break
            }
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
					...
					.then(({data}) => {
						Thakku.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
					})
					break
				case 'waifu': case 'loli':
					...
					.then(({data}) => {
					Thakku.sendImage(m.chat, data.url, mess.success, m)
					})
					break
case "setmenu": 
...
break
                    case 'bug': case 'report': {
                    	...
                    	Thakku.sendMessage(`919961857267@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
│✙ Tᴏᴛᴀʟ Usᴇʀs : ${Object.keys(global.db.data.users).length}
└┬──────────────┈ ⳹
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                Thakku.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c15f725add0381fb69c4b.jpg' }, caption: `*Hi Bro ${m.pushName}*\nDonation section is currently down🥲 , I know you are happy but me 🥲💔\n` }, { quoted: m })
            }
            break
            case 'git': case 'sc': case 'script': {
                reply(`GitHub : https://github.com/TOXIC-KICHU/THAKKU-MD\n Dont Forget To Give Star\n\nYouTube : https://instagram.com/kichu_nrd?igshid=YmMyMTA2M2Y=\nDont Forget To Watch Tutorial`)
            }
            break
case 'help': case 'allmenu': {
  	anu = `
┏━「 *${botname}* 」━━⭓ 
┃╔══☯︎「 Mᴀɪɴ」☯︎
┃╠ ${prefix}alive
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `https://instagram.com/kichu_nrd?igshid=YmMyMTA2M2Y=`}},{"urlButton": {"displayText": "Gɪᴛ Lɪɴᴋ","url": `https://github.com/TOXIC-KICHU/THAKKU-MD`}},{"quickReplyButton": {"displayText": "Dᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "Oᴡɴᴇʀ","id": 'owner'}}] )
break
...
┃╠${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "Iɴsᴛᴀ","url": `https://instagram.com/kichu_nrd?igshid=YmMyMTA2M2Y=`}},{"urlButton": {"displayText": "Gɪᴛ Lɪɴᴋ","url": `https://github.com/TOXIC-KICHU/THAKKU-MD`}},{"quickReplyButton": {"displayText": "Dᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "Oᴡɴᴇʀ","id": 'owner'}}] )
break
...
And Again Me (King Toxic Kichu 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Iɴsᴛᴀ","url": `https://instagram.com/kichu_nrd?igshid=YmMyMTA2M2Y=`}},{"urlButton": {"displayText": "Gɪᴛ Lɪɴᴋ","url": `https://github.com/TOXIC-KICHU/THAKKU-MD`}},{"quickReplyButton": {"displayText": "Dᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "Oᴡɴᴇʀ","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
